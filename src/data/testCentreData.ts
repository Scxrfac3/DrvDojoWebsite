...
export const TEST_CENTRES: TestCentre[] = [
  {
    ...
    routeCount: 8,
    seoTitle: 'Goodmayes Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Goodmayes test centre (58% pass rate) — route tips, trouble spots and expert ADI advice. Book your first 2 hours for £70 with Drive Dojo.',
  ...
  },
  {
    ...
    routeCount: 12,
    seoTitle: 'Wood Green Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Wood Green test centre (42% pass rate) — master the High Road roundabout, test routes and ADI tips. Book your first 2 hours for £70.',
  ...
  },
  {
    ...
    routeCount: 6,
    seoTitle: 'Barking Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Barking test centre (55% pass rate) — A13 gyratory tips, trouble spots and local instructor advice. Book your first 2 hours for £70.',
  ...
  },
  {
    ...
    routeCount: 5,
    seoTitle: 'Hornchurch Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Hornchurch test centre (60% pass rate) — High Street routes, roundabout tips and independent driving advice. Book your first 2 hours for £70.',
  ...
  },
  {
    ...
    routeCount: 7,
    seoTitle: 'Chingford Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Chingford test centre (61% pass rate) — Epping Forest routes and the Crooked Billet roundabout. Route training from our ADIs. Book 2 hours for £70.',
  ...
  },
  {
    ...
    routeCount: 6,
    seoTitle: 'Wanstead Driving Test Centre Routes & Tips | Drive Dojo',
    seoDescription: 'Wanstead test centre (59% pass rate) — master Charlie Brown\'s roundabout, Redbridge Lane and local routes. Book 2 hours for £70.',
