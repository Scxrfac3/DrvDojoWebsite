...
export default function DVSASyllabusTracker() {
  ...
  return (
    <section className="py-8 md:py-12 relative overflow-hidden bg-[#0d0d0d] text-white">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-2xl">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 mb-3 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 group-hover:bg-primary/20 transition-colors"
          >
          ...
          <p className="text-gray-400 text-sm max-w-lg mx-auto">
            {isExpanded
              ...
              : `Track your progress across ${totalSkills} DVSA skills. Click to expand.`}
          </p>
        </motion.button>
        ...
        <AnimatePresence initial={false}>
          {isExpanded && (
            ...
            >
              {/* Progress bar */}
              <div className="bg-[#0d0d0d]/95 backdrop-blur-md border border-white/[0.08] rounded-2xl p-4 mb-6 shadow-lg">
