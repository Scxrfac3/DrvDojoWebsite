...
const OFFERS = [
  ...
  },
  {
    ...
    price: '£650 – £950',
    perHourLabel: '12–30 hours',
    savingsLabel: 'Pass in as little as 2 weeks',
    features: [
      '15–25 hours immersive daily lessons',
      'Structured syllabus with experienced ADI',
      'Theory test support & guidance included',
      'Mock test the week before test date',
      'Flexible scheduling around work or uni',
      'Klarna — interest-free payments available',
    ],
