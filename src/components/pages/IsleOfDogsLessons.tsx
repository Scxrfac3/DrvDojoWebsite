        ...
        <main className="pt-[140px] pb-20 relative z-10">
          ...
          <section className="py-16 bg-[#0d0d0d]">
            <div className="container mx-auto px-4">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
                  What to Watch For When Choosing Driving Lessons in Isle of Dogs
                </h2>
                <p className="text-gray-400 max-w-2xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-primary/10 to-orange-500/10 border border-primary/20 rounded-2xl p-8 max-w-4xl mx-auto">
                <h3 className="text-2xl font-bold mb-4 text-white text-center">How Drive Dojo Is Different in Isle of Dogs</h3>
