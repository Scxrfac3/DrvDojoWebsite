...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How much do driving lessons cost in Forest Gate?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Driving lessons in Forest Gate start from £45 for a 90-minute session. First 2 hours assessed at £49, then £25/hr. Block booking discounts available."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How quickly can I start driving lessons in Forest Gate?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do you serve all E7 and London postcodes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we cover E7, E11, E12, E15, IG postcodes and all surrounding East London areas. We prepare students for Wanstead, Barking, and Goodmayes test centres."
      }
    }
  ]
};
  ...
  return (
    <>
      <SEO
        ...
        description="Skip the waiting lists. View live availability and book your driving lessons instantly in Forest Gate & E7. Learn in a modern Mercedes A-Class with DVSA Approved instructors. Pay in 3 with Klarna. First 2 hours for £49!"
                ...
                >
                  <div className="flex items-center gap-4 mb-6 justify-center lg:justify-start">
                    ...
                    <div className="flex items-center bg-orange-500/20 backdrop-blur-sm px-4 py-2 rounded-full border border-orange-400/30">
                      <span className="text-sm font-medium">Wanstead Prep</span>
                    </div>
                  </div>
                  ...
                  <p className="text-xl text-gray-400 mb-8 leading-relaxed">
                    DVSA approved instructor covering E7, E11, E12, and E15 postcodes.
                    Automatic Mercedes-Benz A-Class. First 2 hours assessed at
                    <span className="text-primary font-semibold"> £49</span>, then
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl transform transition-transform duration-500">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      ...
                      <p className="text-white/90 text-sm">
                        "Great instructor - passed first time with lessons in Forest Gate!"
                      </p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
                  Why Forest Gate Learners Choose Drive Dojo
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-400">
                    Fully qualified instructor who works E7, E11, E12, and E15 daily. National school experience means structured lessons, not guesswork.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-400">
                    13% above the national average. Lessons are tailored to your level, not a fixed syllabus. You pass when you are ready.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white">
                    Covers E Postcodes & Beyond
                  </h3>
                  <p className="text-gray-400">
                    Serving E6, E7, E11, E12, E13, E15, E16, and IG postcodes. Automatic Mercedes-Benz A-Class with dual controls.
                  </p>
                </motion.div>
              </div>
            </div>
          ...
          <section className="py-16 bg-[#0d0d0d]">
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <p className="text-gray-400 max-w-2xl mx-auto">
                  E7, E11, E12, E15, IG postcodes - all within reach. Wanstead, Barking, and Goodmayes test centres covered.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                >
                  <h3 className="text-2xl font-bold mb-4 text-white">
                    Test Route Knowledge Across Three Centres
                  </h3>
                  <p className="text-gray-400 mb-6">
                    Whether your test is at Wanstead, Barking, or Goodmayes, your lessons focus on the approaches, junctions, and road types examiners actually use.
                  </p>

                  <ul className="space-y-3">
                    {[
                      "Specialist lessons across E6, E7, E11, E12, E13, E15, E16",
                      "IG postcodes covered including IG1 through IG6",
                      "Test centre prep for Wanstead, Barking, and Goodmayes",
                      "Training on A406 North Circular and A13",
                      "Flexible scheduling for intensive or weekly lessons",
                    ].map((item, index) => (
                      <motion.li
                        key={index}
          ...
          <section className="py-16 bg-gradient-to-r from-primary to-orange-600 text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Book your first lesson today and start training for Wanstead, Barking, or Goodmayes.
              </motion.p>
