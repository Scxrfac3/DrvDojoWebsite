...
export default function LoginPage() {
  ...
  return (
    <>
      <SEO
        noindex
        title="Sign In - Drive Dojo"
        description="Sign in to your Drive Dojo account to access your driving lessons, progress and the ADI Blueprint."
        canonical="https://drivedojodrivingschool.com/login"
      />
