        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Book Your Pay As You Go Lesson
            </h2>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      ...
                      <h3 className="text-xl font-bold text-white">
                        Pay As You Go Lesson 2 hours
                      </h3>
                    </div>
                    <div className="text-2xl font-bold text-white mb-2">
                      £76
                      <span className="text-sm font-normal">/2 hours</span>
                    </div>
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 p-3 bg-blue-900/30 rounded-lg border border-blue-700/50">
                  <p className="text-blue-200 text-sm font-medium">
                    Selected: <span className="text-orange-300">Pay As You Go Lesson 2 hours</span>
                  </p>
                </div>
              </div>
