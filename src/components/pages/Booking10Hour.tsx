...
const Booking10Hour = () => {
  ...
  const calendlyEmbedHTML = `
    <div class="calendly-inline-widget" data-url="https://calendly.com/drivedojo-qnua/10-hour-package" style="min-width:320px;height:700px;"></div>
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(8)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute rounded-full bg-gradient-to-r from-amber-400/20 to-orange-400/20 backdrop-blur-sm"
            style={{
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 rounded-full flex items-center justify-center mr-3 bg-gradient-to-br from-amber-500/30 to-orange-600/30 border border-amber-500/20">
                  ...
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center text-sm">
                      ...
                      <span className="text-slate-300">10 hours of professional lessons</span>
                    </li>
                    <li className="flex items-center text-sm">
                      <CheckCircle className="h-4 w-4 text-amber-500 mr-3 flex-shrink-0" />
                      <span className="text-slate-300">Progress tracking & feedback</span>
                    </li>
                    <li className="flex items-center text-sm">
                      <CheckCircle className="h-4 w-4 text-amber-500 mr-3 flex-shrink-0" />
