...
const Booking10Hour = () => {
  ...
  const calendlyEmbedHTML = `
    ...
    <div class="calendly-inline-widget" data-url="https://calendly.com/drivedojo-qnua/6-hour-package-clone" style="min-width:320px;height:700px;"></div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Book Your 10-Hour Package
            </h2>
            <div className="bg-gradient-to-b from-purple-900/40 to-purple-800/20 rounded-xl overflow-hidden border border-purple-700/30 shadow-lg relative">
              <div className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center mr-3 bg-purple-600/30 text-purple-400">
                ...
                <ul className="space-y-1 mb-4">
                  <li className="flex items-center text-sm">
                    ...
                    <span className="text-slate-300">10 hours of lessons</span>
                  </li>
                  <li className="flex items-center text-sm">
                    <CheckCircle className="h-4 w-4 text-purple-500 mr-2 flex-shrink-0" />
                  ...
                  <li className="flex items-center text-sm">
                    <CheckCircle className="h-4 w-4 text-purple-500 mr-2 flex-shrink-0" />
                    <span className="text-slate-300">Best value for most learners</span>
                  </li>
                </ul>
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 p-3 bg-blue-900/30 rounded-lg border border-blue-700/50">
                  <p className="text-blue-200 text-sm font-medium">
                    Selected: <span className="text-orange-300">10-Hour Package</span>
                  </p>
                </div>
              </div>
