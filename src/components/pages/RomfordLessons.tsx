...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "How quickly can I start driving lessons in Romford?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Do you serve all RM postcodes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we cover all RM postcodes from RM1 to RM17. We prepare students for Hornchurch and Goodmayes test centres."
      }
    }
  ]
};
                ...
                >
                  <div className="flex items-center gap-4 mb-6 justify-center lg:justify-start">
                    ...
                    <div className="flex items-center bg-orange-500/20 backdrop-blur-sm px-4 py-2 rounded-full border border-orange-400/30">
                      <span className="text-sm font-medium">RM Postcodes</span>
                    </div>
                  </div>
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                    ...
                    <span className="text-white">in Romford</span>
                  </h1>
          ...
          <section className="py-16 bg-[#0d0d0d]">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Why Romford Learners Choose Drive Dojo</h2>
                <p className="text-gray-400 max-w-2xl mx-auto">
                  DVSA approved instructor covering all RM postcodes from RM1 to RM17.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white">Hornchurch & Goodmayes Prep</h3>
                  <p className="text-gray-400">
                    Your test is at Hornchurch or Goodmayes DTC. I tailor every lesson to those specific test routes, so you are not learning blind.
                  </p>
                </motion.div>
                <motion.div
                  className="bg-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:border-primary/40 transition-colors"
                ...
                >
                  ...
                  <p className="text-gray-400">
                    13% above the national average. You pass when you are ready, not when a block of hours runs out.
                  </p>
                </motion.div>
                <motion.div
                  className="bg-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:border-primary/40 transition-colors"
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white">All RM Postcodes</h3>
                  <p className="text-gray-400">
                    RM1 through RM17 covered. Automatic Mercedes-Benz A-Class with dual controls. Door-to-door pickup included.
                  </p>
                </motion.div>
              </div>
            </div>
          ...
          <section className="py-16 bg-[#0d0d0d]">
            <div className="container mx-auto px-4">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Driving in Romford</h2>
                <p className="text-gray-400 max-w-2xl mx-auto">
                  A12, A127, residential roads, and dual carriageways - Romford has everything you need to build test-ready skills.
                </p>
              </motion.div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="text-2xl font-bold mb-4 text-white">Know the Routes Before Test Day</h3>
                  <p className="text-gray-400 mb-6">
                    Every lesson targets the approaches and junctions used at Hornchurch and Goodmayes. No wasted miles on roads you will never be tested on.
                  </p>
                  <ul className="space-y-3">
                    {[
                      "All RM postcodes: RM1 through RM17",
                      "Hornchurch and Goodmayes test route practice",
                      "A12 and A127 dual carriageway training",
                      "Romford's complex junctions and roundabouts",
                      "Mock tests to DVSA standard before test day",
                    ].map((item, index) => (
                      <motion.li
                        key={index}
          ...
          <section className="py-16 bg-gradient-to-r from-primary to-orange-600 text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Book your first lesson and start training for Hornchurch or Goodmayes.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
